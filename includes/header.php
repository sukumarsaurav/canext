...
<body>
    ...
    <div class="side-drawer">
        <div class="drawer-header">
            <a href="<?php echo $base_url; ?>/index.php" class="drawer-logo">CANEXT</a>
        ...
        <nav class="drawer-nav">
            ...
            <div class="drawer-submenu" id="visa-submenu">
                <a href="<?php echo $base_url; ?>/visa-types/Study-Permit.php" class="drawer-submenu-item">
                ...
                <a href="<?php echo $base_url; ?>/visa-types/Work-Permit.php" class="drawer-submenu-item">
                ...
                <a href="<?php echo $base_url; ?>/visa-types/Express-Entry-visa.php" class="drawer-submenu-item">
                ...
                <a href="<?php echo $base_url; ?>/visa-types/Family-Sponsorship.php" class="drawer-submenu-item">
                ...
                <a href="<?php echo $base_url; ?>/visa-types/Provincial-Nominee.php" class="drawer-submenu-item">
                ...
                <a href="<?php echo $base_url; ?>/visa-types/faq.php" class="drawer-submenu-item">
            ...
            <div class="drawer-submenu" id="assessment-submenu">
                <a href="<?php echo $base_url; ?>/assessment-calculator/eligibility-calculator.php" class="drawer-submenu-item">
                ...
                <a href="<?php echo $base_url; ?>/assessment-calculator/crs-score-calculator.php" class="drawer-submenu-item">
                ...
                <a href="<?php echo $base_url; ?>/assessment-calculator/study-permit-checker.php" class="drawer-submenu-item">
            ...
            <div class="drawer-submenu" id="resources-submenu">
                <a href="<?php echo $base_url; ?>/resources/immigration-news.php" class="drawer-submenu-item">
                ...
                <a href="<?php echo $base_url; ?>/resources/guides-tutorials.php" class="drawer-submenu-item">
                ...
                <a href="<?php echo $base_url; ?>/resources/faq.php" class="drawer-submenu-item">
                ...
                <a href="<?php echo $base_url; ?>/resources/blog.php" class="drawer-submenu-item">
            ...
            <a href="<?php echo $base_url; ?>/contact.php" class="drawer-item">Contact</a>
            
            <div class="drawer-cta">
                <a href="<?php echo $base_url; ?>/contact.php" class="btn btn-primary">Book Consultation</a>
            </div>
        </nav>
    </div>
    ...
    <header class="header">
        ...
        <button class="mobile-menu-toggle">
            ...
            <nav>
                <ul class="nav-menu">
                    <li class="nav-item">
                        <a href="<?php echo $base_url; ?>/visas.php">Visa Services <i class="fas fa-chevron-down"></i></a>
                        <div class="dropdown-menu mega-menu">
                            <a href="<?php echo $base_url; ?>/visa-types/Study-Permit.php" class="mega-menu-item">
                            ...
                            <a href="<?php echo $base_url; ?>/visa-types/Work-Permit.php" class="mega-menu-item">
                            ...
                            <a href="<?php echo $base_url; ?>/visa-types/Express-Entry-visa.php" class="mega-menu-item">
                            ...
                            <a href="<?php echo $base_url; ?>/visa-types/Family-Sponsorship.php" class="mega-menu-item">
                                <h4 class="mega-menu-title">Family Sponsorship</h4>
                                <p class="mega-menu-description">Reunite with your family members in Canada</p>
                            </a>
                            <a href="<?php echo $base_url; ?>/visa-types/Provincial-Nominee.php" class="mega-menu-item">
                            ...
                            <a href="<?php echo $base_url; ?>/visa-types/Visitor-Visa.php" class="mega-menu-item">
                            ...
                            <div class="mega-menu-consultation">
                                ...
                                <a href="<?php echo $base_url; ?>/Book-Consultation.php" class="btn btn-primary">Book a Consultation</a>
                            </div>
                        </div>
                    </li>
                    <li class="nav-item">
                        <a href="<?php echo $base_url; ?>/assessment-tools.php">Assessment Tools <i class="fas fa-chevron-down"></i></a>
                        <div class="dropdown-menu">
                            <a href="<?php echo $base_url; ?>/assessment-calculator/eligibility-calculator.php" class="dropdown-item">
                            ...
                            <a href="<?php echo $base_url; ?>/assessment-calculator/crs-score-calculator.php" class="dropdown-item">
                            ...
                            <a href="<?php echo $base_url; ?>/assessment-calculator/study-permit-checker.php" class="dropdown-item">
                    ...
                    <li class="nav-item">
                        <a href="<?php echo $base_url; ?>/resources.php">Resources <i class="fas fa-chevron-down"></i></a>
                        <div class="dropdown-menu">
                            <a href="<?php echo $base_url; ?>/resources/immigration-news.php" class="dropdown-item">
                            ...
                            <a href="<?php echo $base_url; ?>/resources/guides-tutorials.php" class="dropdown-item">
                            ...
                            <a href="<?php echo $base_url; ?>/resources/faq.php" class="dropdown-item">
                            ...
                            <a href="<?php echo $base_url; ?>/resources/blog.php" class="dropdown-item">
                    ...
                    <li class="nav-item"><a href="<?php echo $base_url; ?>/contact.php">Contact</a></li>
                </ul>
            </nav>
            
            <div class="header-actions book-button">
                <a href="<?php echo $base_url; ?>/consultant.php" class="btn btn-primary">Book Consultation</a>
